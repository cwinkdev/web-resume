...
const Skills = () => {
  return (
    ...
    >
      <div
        className={`border-emerald-400 min-h-[700px] h-fit bg-gradient-to-b from-neutral-900 to-neutral-950 justify-evenly flex flex-col rounded-lg border-y py-4 px-6 w-full relative shadow-inner shadow-black`}
      >
